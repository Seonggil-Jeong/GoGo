package com.gogo.user.app.security.token;

import com.gogo.user.app.security.AuthToken;
...
@Slf4j
public class AccessToken implements AuthToken<Claims> {
    ...
    public AccessToken(String id, Key key, String role, Map<String, Object> claims, Date expiredDate) {
        this.key = key;
    ...
    public Optional<String> createJwtAuthToken(String id, String role, Map<String, Object> claimsMap, Date expiredDate) {
        ...
        claims.put(AccessToken.AUTHORITIES_KEY, role);
